...
pub(crate) struct PerfCounters {
    ...
    pub(crate) read_cache_skipped_pressure: AtomicU64,
...
impl PerfCounters {
    pub(crate) fn new() -> Self {
        Self {
            ...
            read_cache_skipped_pressure: AtomicU64::new(0),
    ...
    pub(crate) fn snapshot_json(&self, submit_inflight: u64) -> serde_json::Value {
        serde_json::json!({
            ...
            "read_cache": {
                ...
                "skipped_pressure": self.read_cache_skipped_pressure.load(Ordering::Relaxed),
            }
        })
    }
}
...
pub(crate) struct AppState {
    ...
    pub(crate) market_activity_ms: Arc<DashMap<i16, i64>>,
...
impl AppState {
    pub(crate) fn mark_market_activity(&self, market_id: i16) {
        if market_id <= 0 {
            return;
        }
        self.market_activity_ms.insert(market_id, now_epoch_ms_i64());
    }
